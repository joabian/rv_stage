    ...
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="codeTB" runat="server"></asp:TextBox><br />
                </td>
            </tr>
            <tr>
                <td width="200px" align="right">
            ...
            <tr>
                <td width="200px" align="right">
                    <asp:Label ID="Label6" runat="server" Text="Modelo: "></asp:Label><br />
                </td>
                <td>
            ...
            <tr>
                <td width="200px" align="right">
                    <asp:Label ID="Label4" runat="server" Text="Costo: "></asp:Label><br />
                </td>
                <td>
                    <asp:TextBox ID="costTB" runat="server"></asp:TextBox><br />
                </td>
            </tr>
            <tr>
                <td width="200px" align="right">
                    <asp:Label ID="Label5" runat="server" Text="Inventario Mínimo: "></asp:Label><br />
                </td>
                <td>
                    <asp:TextBox ID="low_inventoryTB" runat="server"></asp:TextBox><br />
                </td>
            </tr>
            <tr>
                <td width="200px" align="right">
                    <asp:Label ID="Label7" runat="server" Text="Categoría: "></asp:Label><br />
                </td>
                <td>
                    <asp:DropDownList ID="categoryDD" runat="server" DataSourceID="ObjectDataSource1" DataTextField="name" DataValueField="id"></asp:DropDownList><br />
                </td>
            </tr>
            <tr>
                <td></td>
                <td>
                    <br />
                    <asp:Button ID="save_product" runat="server" Text="Guardar Producto" />
                </td>
            </tr>
